...
![Time Series Chart Practice](https://github.com/Alexandra-Kaplan/Alexandra-Kaplan.github.io/blob/main/Time_Series_Spreadsheet_Practice_Arts_and_Sciences_Business__Engineering_chartbuilder.png?raw=true)

Here is a chart that we did in class to practice a time series chart. This chart shows the change over time from 2017-2020 about enrollment in different colleges at Lehigh University. A reader can learn that the Engineering College over time has had the most decrease. Additionally, Arts and Sciences appears to have the most variation over the past 5 years. This chart was made with [Chart Builder](https://quartz.github.io/Chartbuilder/) and the data gathered for the Lehigh enrollment information was collected from [University Profile](https://oirsa.lehigh.edu/university-profile)
